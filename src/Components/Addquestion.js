...
const getUserQuestions=async()=>{
  ...
  const response =await axios.get(`${process.env.REACT_APP_API_KEY}/get/user/question?user_id=${logged_user}`).then(response => {
...
<InputGroup>
  ...
  ):(console.log("Icebreaker question is selected with open ended type"))}
  </div>
}
